d3x ray job submit --submission-id llamaft_t4\
           --runtime-env-json '{"pip":["mlflow"]}' \
           --working-dir $PWD \
           -- python finetuning_mak.py --use_peft --peft_method lora \
                                   --model_name $HOME/models/models--meta-llama--Llama-2-7b-chat-hf/snapshots/08751db2aca9bf2f7f80d2e516117a53d7450235/  \
                                   --batch_size_training 4 \
                                   --num_epochs 3 \
                                   --experiment_name llama27bft_v1_12-oct-23 --run_name finetuning \
